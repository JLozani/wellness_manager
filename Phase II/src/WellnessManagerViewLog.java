...
public class WellnessManagerViewLog extends JPanel {
   private JButton back, go, set, add, addExercise, delete;
   ...
   public double getCalories() {
      return Double.parseDouble(calories.getText());
   }
   ...
   public void setWellnessActionListener(ActionListener wellnessListener) {
      ...
      addExercise.addActionListener(wellnessListener);
